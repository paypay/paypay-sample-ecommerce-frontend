    ...
    <div class="orderpayment">
        <div class="orderpayment-contents">
            <div class="main-content">
                ...
                <p class="payment-amount" v-if="orderStatus.amount">￥   {{orderStatus.amount.amount.toFixed(2)}}</p>

                <div class="cake-description">
                    <div class="cake-details"  :key="index" v-for="(item,index) in orderStatus.orderItems">
                ...
                <div class="merchantid" v-if="orderStatus">
                    ...
                    <span class="merchant-number">{{orderStatus.merchantPaymentId}}</span>
                </div>
            </div>
        </div>
    </div>
